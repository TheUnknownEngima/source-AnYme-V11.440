...
The second source code is from the NSFW patch that adds support for some hentai sites, enjoy ( ͡° ͜ʖ ͡°).

THAT ALL IS BULLSHIT, YOU CAN'T BUILD IT FROM THIS SOURCE
