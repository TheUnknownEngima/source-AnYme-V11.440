...
class Interpolators {
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_SCALE_X {
        public static final Interpolator INSTANCE = f5.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
        ...
        static {
            ...
            PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X.lineTo(0.3665f, Utils.FLOAT_EPSILON);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X {
        public static final Interpolator INSTANCE = f5.a(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
        ...
        static {
            ...
            path.moveTo(Utils.FLOAT_EPSILON, Utils.FLOAT_EPSILON);
            PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.lineTo(0.2f, Utils.FLOAT_EPSILON);
            PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.cubicTo(0.39583334f, Utils.FLOAT_EPSILON, 0.47484508f, 0.20679761f, 0.59166664f, 0.41708294f);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_SCALE_X {
        public static final Interpolator INSTANCE = f5.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X {
        public static final Interpolator INSTANCE = f5.a(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
        ...
        static {
            ...
            path.moveTo(Utils.FLOAT_EPSILON, Utils.FLOAT_EPSILON);
            PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X.cubicTo(0.0375f, Utils.FLOAT_EPSILON, 0.12876461f, 0.0895381f, 0.25f, 0.21855351f);
    ...
    public static class TRIM_PATH_END {
        public static final Interpolator INSTANCE = f5.a(PATH_TRIM_PATH_END);
    ...
    public static class TRIM_PATH_START {
        public static final Interpolator INSTANCE = f5.a(PATH_TRIM_PATH_START);
        private static final Path PATH_TRIM_PATH_START;

        static {
            Path path = new Path();
            PATH_TRIM_PATH_START = path;
            path.lineTo(0.5f, Utils.FLOAT_EPSILON);
            PATH_TRIM_PATH_START.cubicTo(0.7f, Utils.FLOAT_EPSILON, 0.6f, 1.0f, 1.0f, 1.0f);
        }
    }
