...
public final class i {
    ...
    public static j3.a g(TextView textView) {
        if (Build.VERSION.SDK_INT >= 28) {
            return new j3.a(textView.getTextMetricsParams());
        }
        j3.a.C0129a aVar = new j3.a.C0129a(new TextPaint(textView.getPaint()));
    ...
    public static void q(TextView textView, j3 j3Var) {
        Spanned spanned;
        if (Build.VERSION.SDK_INT >= 29) {
            spanned = j3Var.b();
        } else {
            boolean a2 = g(textView).a(j3Var.a());
            spanned = j3Var;
            if (!a2) {
    ...
    public static void s(TextView textView, j3.a aVar) {
        if (Build.VERSION.SDK_INT >= 18) {
