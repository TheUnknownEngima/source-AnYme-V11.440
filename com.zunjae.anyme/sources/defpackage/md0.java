...
public enum md0 implements fl0 {
    ...
    private static final il0<md0> zzahh = null;
    ...
    public final String toString() {
        return "<" + md0.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
    }
