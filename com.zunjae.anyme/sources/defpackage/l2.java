...
public class l2 {
    ...
    public static class b {
        ...
        b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.b;
            this.b = l2.c(fArr, 0, fArr.length);
        }
        ...
        private static void a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        if (c3 == 'c') {
                            ...
                            if (c3 != 'q') {
                                if (c3 == 'v') {
                                    int i18 = i3 + 0;
                                    path2.rLineTo(Utils.FLOAT_EPSILON, fArr3[i18]);
                                    f6 = fArr3[i18];
                                } else if (c3 != 'L') {
                                    if (c3 == 'M') {
                                        int i19 = i3 + 0;
                            ...
                            int i43 = i3 + 0;
                            path2.rLineTo(fArr3[i43], Utils.FLOAT_EPSILON);
                            f17 += fArr3[i43];
                        }
                        i2 = i3;
                    } else {
                        ...
                        int i45 = i3 + 6;
                        i2 = i3;
                        c(path, f17, f18, fArr3[i44] + f17, fArr3[i45] + f18, fArr3[i3 + 0], fArr3[i3 + 1], fArr3[i3 + 2], fArr3[i3 + 3] != Utils.FLOAT_EPSILON, fArr3[i3 + 4] != Utils.FLOAT_EPSILON);
                        f = f17 + fArr3[i44];
                        f2 = f18 + fArr3[i45];
                    }
                    i3 = i2 + i;
                    ...
                    int i46 = i2 + 5;
                    int i47 = i2 + 6;
                    c(path, f17, f18, fArr3[i46], fArr3[i47], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != Utils.FLOAT_EPSILON, fArr3[i2 + 4] != Utils.FLOAT_EPSILON);
                    f = fArr3[i46];
                    f2 = fArr3[i47];
                }
                f14 = f18;
        ...
        private static void c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d22 != Utils.DOUBLE_EPSILON) {
                ...
                if (d23 < Utils.DOUBLE_EPSILON) {
                    ...
                    c(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                    return;
                }
                ...
                double d26 = d2 * d15;
                double d27 = d * d11;
                b(path, (d26 * cos) - (d27 * d21), (d26 * d21) + (d27 * cos), d15, d11, d5, d10, radians, atan2, atan22);
            }
        }
    ...
    private static void g(java.lang.String r8, int r9, defpackage.l2.a r10) {
        /*
            r0 = 0
            r10.b = r0
            r1 = r9
        ...
        L_0x003b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l2.g(java.lang.String, int, l2$a):void");
    }
