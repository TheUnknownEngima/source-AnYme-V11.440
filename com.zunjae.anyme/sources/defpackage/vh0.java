...
public enum vh0 implements fl0 {
    ...
    private static final il0<vh0> zzahh = null;
    ...
    public final String toString() {
        return "<" + vh0.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.value + " name=" + name() + '>';
    }
