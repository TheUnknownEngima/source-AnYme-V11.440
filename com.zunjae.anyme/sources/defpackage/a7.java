...
public class a7 {
    ...
    /* renamed from: a7$a */
    private static class a implements TypeEvaluator<l2.b[]> {
        private l2.b[] a;
        ...
        /* renamed from: a */
        public l2.b[] evaluate(float f, l2.b[] bVarArr, l2.b[] bVarArr2) {
            if (l2.b(bVarArr, bVarArr2)) {
    ...
    private static Animator a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f) {
        return b(context, resources, theme, xmlPullParser, Xml.asAttributeSet(xmlPullParser), (AnimatorSet) null, 0, f);
    }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = defpackage.w6.h
            r7 = r22
            android.content.res.TypedArray r6 = defpackage.i2.s(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = defpackage.i2.k(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
        ...
        L_0x0106:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a7.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            l2$b[] r13 = defpackage.l2.d(r12)
            l2$b[] r14 = defpackage.l2.d(r11)
        ...
        L_0x0054:
            ...
            boolean r3 = defpackage.l2.b(r13, r14)
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a7.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray s = i2.s(resources, theme, attributeSet, w6.j);
        int i = 0;
        TypedValue t = i2.t(s, xmlPullParser, "value", 0);
        if ((t != null) && h(t.type)) {
            i = 3;
        }
        s.recycle();
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) {
        TypedArray s = i2.s(resources, theme, attributeSet, w6.g);
        TypedArray s2 = i2.s(resources, theme, attributeSet, w6.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, s, s2, f, xmlPullParser);
        int l = i2.l(s, xmlPullParser, "interpolator", 0, 0);
        if (l > 0) {
            valueAnimator.setInterpolator(z6.b(context, l));
        }
        s.recycle();
        if (s2 != null) {
            s2.recycle();
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        TypedArray s = i2.s(resources, theme, attributeSet, w6.j);
        float j = i2.j(s, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue t = i2.t(s, xmlPullParser, "value", 0);
        boolean z = t != null;
        if (i == 4) {
            i = (!z || !h(t.type)) ? 0 : 3;
        }
        Keyframe ofInt = z ? i != 0 ? (i == 1 || i == 3) ? Keyframe.ofInt(j, i2.k(s, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(j, i2.j(s, xmlPullParser, "value", 0, Utils.FLOAT_EPSILON)) : i == 0 ? Keyframe.ofFloat(j) : Keyframe.ofInt(j);
        int l = i2.l(s, xmlPullParser, "interpolator", 1, 0);
        if (l > 0) {
            ofInt.setInterpolator(z6.b(context, l));
        }
        s.recycle();
        return ofInt;
    }
    ...
    private static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) {
        ...
        L_0x00dc:
            ...
            b7 r9 = defpackage.b7.a()
            r0.setEvaluator(r9)
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a7.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        ...
        L_0x0016:
            ...
            int[] r0 = defpackage.w6.i
            r11 = r18
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = defpackage.i2.s(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = defpackage.i2.m(r14, r6, r0, r1)
            r0 = 4
            java.lang.String r1 = "valueType"
            int r5 = defpackage.i2.k(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
        ...
        L_0x007f:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.a7.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long k = (long) i2.k(typedArray, xmlPullParser, "duration", 1, 300);
        long k2 = (long) i2.k(typedArray, xmlPullParser, "startOffset", 2, 0);
        int k3 = i2.k(typedArray, xmlPullParser, "valueType", 7, 4);
        if (i2.r(xmlPullParser, "valueFrom") && i2.r(xmlPullParser, "valueTo")) {
            if (k3 == 4) {
                k3 = f(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(i2.k(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(i2.k(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        String m = i2.m(typedArray, xmlPullParser, "pathData", 1);
        if (m != null) {
            String m2 = i2.m(typedArray, xmlPullParser, "propertyXName", 2);
            String m3 = i2.m(typedArray, xmlPullParser, "propertyYName", 3);
            if (i != 2) {
            }
            if (m2 == null && m3 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(l2.e(m), objectAnimator, f * 0.5f, m2, m3);
            return;
        }
        objectAnimator.setPropertyName(i2.m(typedArray, xmlPullParser, "propertyName", 0));
    }
