...
public class i2 {
    ...
    public static ColorStateList g(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i) {
        ...
        if (i2 != 2) {
            return (i2 < 28 || i2 > 31) ? c2.c(typedArray.getResources(), typedArray.getResourceId(i, 0), theme) : h(typedValue);
        }
    ...
    public static d2 i(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i, int i2) {
        if (r(xmlPullParser, str)) {
            TypedValue typedValue = new TypedValue();
            typedArray.getValue(i, typedValue);
            int i3 = typedValue.type;
            if (i3 >= 28 && i3 <= 31) {
                return d2.b(typedValue.data);
            }
            d2 g = d2.g(typedArray.getResources(), typedArray.getResourceId(i, 0), theme);
            if (g != null) {
                return g;
            }
        }
