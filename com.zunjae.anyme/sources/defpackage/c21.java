...
final class c21 extends w11 {
    ...
    private static int e(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return v11.i(i, s11.a(bArr, j));
        }
        if (i2 == 2) {
            return v11.j(i, s11.a(bArr, j), s11.a(bArr, j + 1));
        }
    ...
    public final int a(int r16, byte[] r17, int r18, int r19) {
        ...
        L_0x001e:
            ...
            long r13 = r11 + r9
            byte r3 = defpackage.s11.a(r0, r11)
        ...
        L_0x0032:
            ...
            long r11 = r7 + r9
            byte r1 = defpackage.s11.a(r0, r7)
        ...
        L_0x006d:
            int r2 = r2 + -2
            long r13 = r7 + r9
            byte r7 = defpackage.s11.a(r0, r7)
        ...
        L_0x0083:
            long r7 = r13 + r9
            byte r1 = defpackage.s11.a(r0, r13)
        ...
        L_0x0093:
            int r2 = r2 + -3
            long r13 = r7 + r9
            byte r3 = defpackage.s11.a(r0, r7)
        ...
        L_0x00b7:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.c21.a(int, byte[], int, int):int");
    }
    ...
    public final int b(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x00ae:
            ...
            r12 = r12 | r11
            byte r12 = (byte) r12
            defpackage.s11.l(r1, r4, r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            defpackage.s11.l(r1, r14, r2)
            r2 = r3
        L_0x00fb:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0146:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.c21.b(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    public final String d(byte[] bArr, int i, int i2) {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte a2 = s11.a(bArr, (long) r13);
                if (x11.l(a2)) {
                    int i7 = i5 + 1;
                    x11.i(a2, cArr, i5);
                    while (i6 < i3) {
                        byte a3 = s11.a(bArr, (long) i6);
                        if (!x11.l(a3)) {
                            break;
                        }
                        i6++;
                    ...
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        x11.h(a2, s11.a(bArr, (long) i6), cArr, i5);
                        r13 = i8;
                        i5++;
                    } else {
                        throw ez0.f();
                    ...
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        x11.g(a2, s11.a(bArr, (long) i6), s11.a(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw ez0.f();
                    ...
                    int i11 = i6 + 1;
                    byte a4 = s11.a(bArr, (long) i6);
                    int i12 = i11 + 1;
                    x11.f(a2, a4, s11.a(bArr, (long) i11), s11.a(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw ez0.f();
