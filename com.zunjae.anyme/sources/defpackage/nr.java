...
public final class nr {
    ...
    public static int a(byte[] r7) {
        ...
        L_0x0063:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.nr.a(byte[]):int");
    }

    private static h50 b(byte[] bArr) {
        ...
        h50 h50 = new h50(copyOf);
        if (copyOf[0] == 31) {
            h50 h502 = new h50(copyOf);
            while (h502.b() >= 16) {
                h502.q(2);
                h50.f(h502.h(14), 14);
            }
    ...
    public static f0 g(byte[] bArr, String str, String str2, ns nsVar) {
        h50 b2 = b(bArr);
        b2.q(60);
        int i = a[b2.h(6)];
        int i2 = b[b2.h(4)];
        ...
        b2.q(10);
        return f0.p(str, "audio/vnd.dts", (String) null, i3, -1, i + (b2.h(2) > 0 ? 1 : 0), i2, (List<byte[]>) null, nsVar, 0, str2);
    }
}
