...
public final class AnimeRecommendationsActivity extends AbstractActivity {
    ...
    public static final class b {
        ...
        public final Intent a(Context context, int i, String str) {
            ...
            Intent intent = new Intent(context, AnimeRecommendationsActivity.class);
    ...
    static final class c<T> implements u<com.zunjae.vresult.a<? extends List<? extends ux1>>> {
        final /* synthetic */ AnimeRecommendationsActivity a;
        ...
        c(AnimeRecommendationsActivity animeRecommendationsActivity) {
            this.a = animeRecommendationsActivity;
        }
        ...
        public final void a(com.zunjae.vresult.a<? extends List<ux1>> aVar) {
            if (aVar instanceof a.c) {
                ...
                AnimeRecommendationsActivity.o0(this.a).K((List) ((a.e) aVar).b());
                ...
                fw1.f.h((RecyclerView) this.a.l0(C0275R$id.recyclerViewCharacters), "No recommendations found");
    ...
    public static final /* synthetic */ AnimeRecommendationsAdapter o0(AnimeRecommendationsActivity animeRecommendationsActivity) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        j0(toolbar, "Recommendations", stringExtra, true);
        p0();
    }
