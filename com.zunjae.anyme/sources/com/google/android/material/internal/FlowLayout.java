...
public class FlowLayout extends ViewGroup {
    ...
    private void d(Context context, AttributeSet attributeSet) {
        ...
        this.f = obtainStyledAttributes.getDimensionPixelSize(R$styleable.FlowLayout_itemSpacing, 0);
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ...
                    i5 = b4.b(marginLayoutParams);
                    i6 = b4.a(marginLayoutParams);
                } else {
                    i6 = 0;
                    i5 = 0;
                }
                ...
                i8 += i5 + i6 + childAt.getMeasuredWidth() + this.f;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                paddingLeft = i5 + i4 + i3 + childAt.getMeasuredWidth() + this.f;
