...
public class SnackbarContentLayout extends LinearLayout implements a {
    ...
    private static void d(View view, int i, int i2) {
        if (o4.Q(view)) {
            o4.w0(view, o4.D(view), i, o4.C(view), i2);
        } else {
    ...
    public void b(int i, int i2) {
        ...
        long j = (long) i2;
        long j2 = (long) i;
        this.e.animate().alpha(Utils.FLOAT_EPSILON).setDuration(j).setStartDelay(j2).start();
        if (this.f.getVisibility() == 0) {
            this.f.setAlpha(1.0f);
            this.f.animate().alpha(Utils.FLOAT_EPSILON).setDuration(j).setStartDelay(j2).start();
        }
    }
    ...
    public void c(float f2) {
        if (f2 != 1.0f) {
            this.f.setTextColor(t91.g(t91.d(this, R$attr.colorSurface), this.f.getCurrentTextColor(), f2));
        }
    }
